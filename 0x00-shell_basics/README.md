...
Project done during **Full Stack Software Engineering studies** at **ALX SE Program School**. It aims to learn about basics commands, navigation, files and directories in **Shell**.
